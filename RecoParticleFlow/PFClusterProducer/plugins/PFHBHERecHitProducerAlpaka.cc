...
class PFHBHERecHitProducerAlpaka final : public edm::stream::EDProducer<> {
public:
...
#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(PFHBHERecHitProducerAlpaka);
...
void PFHBHERecHitProducerAlpaka::beginRun(edm::Run const& iRun, const edm::EventSetup& iSetup) {
...
void PFHBHERecHitProducerAlpaka::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
