...
class HBHERecHit; // defined in "DataFormats/HcalRecHit/interface/HBHERecHit.h"
class EcalRecHit; // defined in "DataFormats/EcalRecHit/interface/EcalRecHit.h"
